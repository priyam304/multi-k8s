...
docker build -t priyam304/multi-client:latest -t priyam304/multi-client:$SHA ./client 
docker build -t priyam304/multi-server:latest -t priyam304/multi-server:$SHA ./server 
docker build -t priyam304/multi-worker:latest -t priyam304/multi-worker:$SHA ./worker 
